...
const patches_32 = {
  ...
  sniper_accuracy: { name: "Sniper-Only Accuracy", offset: 0x0081335c, bytes: [0xa0, 0x12, 0x90, 0xe5, 0x09, 0x00, 0x51, 0xe3, 0x00, 0x00, 0xa0, 0x03, 0xa2, 0x0a, 0x90, 0x1d, 0x10, 0x0a, 0x10, 0x1e, 0x1e, 0xff, 0x2f, 0xe1] },
  grenade: { name: "Infinite Grenades", offset: 0x007ac340, bytes: [0x03, 0x00, 0xa0, 0xe3, 0x1e, 0xff, 0x2f, 0xe1] }
};
...
const patches_64 = {
  ...
  sniper_accuracy: { name: "Sniper-Only Accuracy", offset: 0x009487c0, bytes: [0x08, 0x38, 0x43, 0xb9, 0x1f, 0x25, 0x00, 0x71, 0xe0, 0x03, 0x27, 0x1e, 0x40, 0x00, 0x00, 0x54, 0x00, 0x1c, 0x43, 0xbd, 0xc0, 0x03, 0x5f, 0xd6] },
  grenade: { name: "Infinite Grenades", offset: 0x008edea4, bytes: [0x60, 0x00, 0x80, 0x52, 0xc0, 0x03, 0x5f, 0xd6] }
};
...
async function run(args) {
  ...
  for (const filename of targetApks) {
    ...
    const { Zip } = require('@chromeos/android-package-signer/dist/lib/Zip.js');
